...
if ($result && $result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<td>
            <button class="clear-btn" data-user-id="' . $row['user_id'] . '" style="cursor: pointer; background-color: green; border: none; color: white; padding: 4px; border-radius: 4px;">Clear</button> </br>
            <button class="addMinor-btn" data-user-id="' . $row['user_id'] . '" style="cursor: pointer; background-color: #FF8C00; border: none; color: white; padding: 4px; border-radius: 4px;">Add Minor</button> 
            <button class="addMajor-btn" data-user-id="' . $row['user_id'] . '" style="cursor: pointer; background-color: red; border: none; color: white; padding: 4px; border-radius: 4px;">Add Major</button>
            </td>';
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var addMajorBtns = document.querySelectorAll('.addMajor-btn');
  var addMinorBtns = document.querySelectorAll('.addMinor-btn');
  ...
  clearBtns.forEach(function(btn) {
    btn.addEventListener('click', function() {
      ...
      xhr.open('POST', 'clear_status.php');
  ...
  addMajorBtns.forEach(function(btn) {
    btn.addEventListener('click', function() {
      var userId = this.getAttribute('data-user-id');
      
      var xhr = new XMLHttpRequest();
      xhr.open('POST', 'addMajor_status.php');
      xhr.setRequestHeader('Content-Type', 'application/json;charset=UTF-8');
      xhr.onload = function() {
        if (xhr.status === 200) {
          console.log('Status updated successfully');
  ...
  addMinorBtns.forEach(function(btn) {
    btn.addEventListener('click', function() {
      var userId = this.getAttribute('data-user-id');
      
      var xhr = new XMLHttpRequest();
      xhr.open('POST', 'addMinor_status.php');
      xhr.setRequestHeader('Content-Type', 'application/json;charset=UTF-8');
      xhr.onload = function() {
        if (xhr.status === 200) {
          console.log('Status updated successfully');
